...
PM_START_TEXT = """
`Hellow My name is` *ᴇᴍɪʟɪᴀ ᴄʟᴀʀᴋᴇ*
...
buttons = [
    [
        InlineKeyboardButton(
            text="ADD ME", url="t.me/Emili_clarkebot?startgroup=true"),
    ],
    [
...
def Masha_about_callback(update: Update, context: CallbackContext):
    ...
    if query.data == "masha_":
        query.message.edit_text(
            text=""" ℹ️ I'm *ᴇᴍɪʟɪᴀ ᴄʟᴀʀᴋᴇ*, a powerful group management bot built to help you manage your group easily.
                 ...
                 \n_ᴇᴍɪʟɪᴀ ᴄʟᴀʀᴋᴇ's licensed under the GNU General Public License v3.0_
                 Here is the [SUPPORT](https://t.me/cpbotz).
                 If you have any question about ᴇᴍɪʟɪᴀ ᴄʟᴀʀᴋᴇ, let us know at @cpbotz.""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
...
def Source_about_callback(update: Update, context: CallbackContext):
    ...
    if query.data == "source_":
        query.message.edit_text(
            text=""" Hi..🤗 I'm *ᴇᴍɪʟɪᴀ ᴄʟᴀʀᴋᴇ* THIS BOT CURRENTLY A CLOSED SOURCE CONTACT DEV FOR REPO
                 \nHere is the [DEV](https://t.me/cpbotssupport) .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=False,
            reply_markup=InlineKeyboardMarkup(
                [
